...
### Added
- **i18n**: Added internationalization (`i18n`) support to the landing page, migrating static text strings to use the `useTranslation` hook and `en.json`.
...
### Fixed
- **Transaction Date**: Fixed date initialization to use the local timezone instead of UTC, preventing date offset issues depending on the time of day.
---
