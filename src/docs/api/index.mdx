...
- [Product Vision](_media/product_vision.md)
- [Architecture & DB Schema](docs/architecture.md)
- [Design System](_media/design_system.md)
- [Future Roadmap](_media/roadmap.md)

## 🤝 Contributing
Contributions, issues, and feature requests are welcome! See our [Contributing Guide](_media/CONTRIBUTING.md) to get started.

## 📄 License
This codebase is MIT Licensed. See [LICENSE](_media/LICENSE) for details.
